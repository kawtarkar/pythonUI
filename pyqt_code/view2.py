...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.clicked.connect(self.add_medicament)
    ...
    def add_medicament(self):
        ...
        # Call the insert_medicament method from DatabaseHandler
        self.db.insert_medicament(nom_m, description, fournisseur, prix, quantite, date_peremption)

        # Optionally, display a message to confirm that the medicament was added
        QtWidgets.QMessageBox.information(self.centralwidget, "Medicament Added", "Medicament has been added successfully.")
        ...
        # Update the list of medicaments in the second view
